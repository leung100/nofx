...
Applies all necessary changes for the news monitoring feature
"""
...
def apply_changes():
    """Apply all news monitoring changes"""

    print("🚀 Applying News Monitoring Integration...")
    print("")

    # Change 1: config/database.go
    print("1️⃣  Updating config/database.go...")
    ...
    # Update CreateTrader values - find the line with trader.IsCrossMargin)
    content = re.sub(
    ...
    print("✅ config/database.go updated")
    print("")

    # Change 2: trader/auto_trader.go
    print("2️⃣  Updating trader/auto_trader.go...")
    ...
    print("✅ trader/auto_trader.go updated")
    print("")

    # Change 3: decision/engine.go
    print("3️⃣  Updating decision/engine.go...")
    ...
    # Add news context to buildUserPrompt
...
\t}'''
    ...
    print("✅ decision/engine.go updated")
    print("")

    # Change 4: api/server.go
    print("4️⃣  Updating api/server.go...")
    ...
    if content.count('UseOITop:             req.UseOITop,') > 1:
        # Multiple occurrences, replace the second one (in handleUpdateTrader)
    ...
    print("✅ api/server.go updated")
    print("")

    # Change 5: web/src/types.ts
    print("5️⃣  Updating web/src/types.ts...")
    ...
    print("✅ web/src/types.ts updated")
    print("")

    # Change 6: web/src/components/TraderConfigModal.tsx
    print("6️⃣  Updating web/src/components/TraderConfigModal.tsx...")
    ...
    print("✅ web/src/components/TraderConfigModal.tsx updated")
    print("   ⚠️  You still need to manually add the UI checkbox (see below)")
    print("")

    # Change 7: .env.example
    print("7️⃣  Updating .env.example...")
    ...
    if 'CRYPTOPANIC_API_KEY' not in env_content:
        with open(env_file, 'a') as f:
            f.write('\n# News Monitoring APIs (Optional - fallback to free sources if not set)\n')
    ...
    print("Add this checkbox in TraderConfigModal.tsx after the 'use_oi_top' checkbox:")
    print("")
    print("""
<div className="flex items-center gap-3">
  ...
  <label className="text-sm text-[#EAECEF]">
    ...
    """)
    print("")
    print("💾 All files backed up with .backup extension")
    print("🔍 Review changes: git diff")
    print("🚀 Test: ./start.sh restart --build")
...
if __name__ == "__main__":
    try:
        ...
        print(f"❌ Error: {e}")
        print("Check the manual guide: NEWS_MONITORING_CHANGES.md")
